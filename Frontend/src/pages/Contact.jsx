                                    ...
                                    <div className = 'container'>
                                            ...
                                            <div className = 'subtitle is-lato is-6' style = {{ marginTop: '10px'}}>
                                                <ul>
                                                    <li style = {{marginBottom: '15px'}}>
                                                        <span>Lokkeshwar Y (<strong>Chairman</strong>)</span>
                                                        <br/>
                                                        <span className = 'icon' style = {{marginLeft: '-6px', marginTop: '5px'}}>
                                                            <FontAwesomeIcon icon = {faMobileAlt} />
                                                        </span>
                                                        <a href = 'tel: +917094239800'>+91 7094239800</a><br/>
                                                    ...
                                                    <li style = {{marginBottom: '15px'}}>
                                                        ...
                                                        <a href = 'tel: +919840382404'>9840382404 </a><br/>
                                                         {/*<span className = 'icon' style = {{position: 'relative', top: '3px',marginLeft: '-4px', marginRight: '2px'}}>
                                                            <FontAwesomeIcon icon = {faEnvelope} />
                                                        </span>
                                                        <a href = 'mailto: workshop@samhita.org.in'>workshop@samhita.org.in</a> */}
                                                    ...
                                                    <li style = {{marginBottom: '15px'}}>
                                                        Surya Prakash P (<strong>Event coordinator</strong>)<br/>
                                                        <span className = 'icon' style = {{marginLeft: '-6px', marginTop: '5px'}}>
                                                            <FontAwesomeIcon icon = {faMobileAlt} />
                                                        </span>
                                                        <a href = 'tel: +919080184950'>+91 9080184950</a><br/>
                                                        {/* <span className = 'icon' style = {{position: 'relative', top: '3px',marginLeft: '-4px', marginRight: '2px'}}>
                                                            <FontAwesomeIcon icon = {faEnvelope} />
                                                        </span>
                                                    ...
                                                    <li style = {{marginBottom: '15px'}}>
                                                        Prathap G (<strong>Accommodation coordinator</strong>)<br/>
                                                        <span className = 'icon' style = {{marginLeft: '-6px', marginTop: '5px'}}>
                                                            <FontAwesomeIcon icon = {faMobileAlt} />
                                                        </span>
                                                        <a href = 'tel: +919047748348'>+91 9047748348</a><br/>
                                                         {/*<span className = 'icon' style = {{position: 'relative', top: '3px',marginLeft: '-4px', marginRight: '2px'}}>
                                                            <FontAwesomeIcon icon = {faEnvelope} />
                                                        </span>
                                                    ...
                                                    <li style = {{marginBottom: '15px'}}>
                                                        Hariharan R (<strong>Sponsorship coordinator</strong>)<br/>
                                                        <span className = 'icon' style = {{marginLeft: '-6px', marginTop: '5px'}}>
                                                            <FontAwesomeIcon icon = {faMobileAlt} />
                                                        </span>
                                                        <a href = 'tel: +919445778177'>+91 9445778177</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div className = 'field'>
                                            ...
                                            <span className = 'icon' style = {{position: 'relative', top: '3px',marginLeft: '-4px', marginRight: '2px'}}>
                                                ...
                                                <a href = 'mailto: samhita2k22@gmail.com'>
                                                    samhita2k22@gmail.com
                                                </a>
                                            </div>
                                        </div>
                                        <div className = 'field' style = {{margin: '25px auto'}}>
                                            <div className = 'control is-size-6 is-lato'>
                                                <strong>Staff incharge: </strong>Dr. G. Rajesh
                                            </div>
                                            <div className = 'subtitle is-lato is-6 email-label' style = {{marginTop: '2px', marginLeft: '-6px'}}>
                                                ...
                                                <a href = 'mailto:raajiimegce@gmail.com'>
                                                raajiimegce@gmail.com
                                                </a>
                                            </div>
                                        </div>
                                        <div className = 'field'>
                        ...
                        <div className = 'navbar-item'>
                            <div className = 'field'>
                                <div className = 'credit-title'>
                                    <div className = 'subtitle is-6 is-lato'><strong>Site designed and developed by</strong><br/><a href = 'mailto:samhita2k22@gmail.com' target = '_blank' rel="noopener noreferrer">Techteam-SAMHITA'22</a>
                                    </div>
                                </div>
                            </div>
                        </div>
