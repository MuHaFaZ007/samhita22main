...
class Register extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Helmet>
                    <title>Samhita 22 - Sign up</title>
                </Helmet>
                <Navbar name = 'account'/>
                                ...
                                <section className = 'section'>
                                    <div className = 'container register-form-container'>
                                        <div className = 'register-form'>
                                            <div className = 'title is-3 is-lato' style={{color:'#276CDA'}}>
                                                Sign up
                                            </div>
                                            <div className = 'field'>
                                                <div className = 'control'>
                                                    <label className = 'is-size-5 is-lato'>
                                                        Name
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div className = 'field'>
                                                <div className = 'control policy' style = {{margin: '2rem', marginBottom: '-1rem'}}> 
                                                    <div className = 'subtitle is-lato is-6'>
                                                        By signing up, you accept Samhita 22's <span className = 'has-text-link' style = {{cursor: 'pointer'}} onClick = {() => this.setModalVisible(true)}>Terms & conditions</span> and <span className = 'has-text-link' style = {{cursor: 'pointer'}} onClick = {() => this.setPrivacyModalVisible(true)}>Privacy policy</span>, and agree to receive occasional emails and text message updates about Samhita 2022
                                                    </div>
                                                </div>
