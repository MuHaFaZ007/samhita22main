...
class Ticket extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>Samhita 22 - Checkout</title>
                </Helmet>
                <section className = 'section' style = {{minHeight: '100vh', backgroundColor: '#090a2b'}}>
                    <div data-aos = 'fade-down' className = 'title is-3 is-lato has-text-centered' style={{color:'#ffffff'}}>
                        Checkout 
                        <span className = 'icon' style = {{marginLeft: '10px'}}>
                            <FontAwesomeIcon icon = {faShoppingCart} size = 'sm' color='#ffffff'/>
                        </span>
                    </div>
                    {
                        isLoading ? 
                                ...
                                <tbody style = {{borderRadius: '20px'}}>
                                    {
                                        ...
                                        <tr className = 'checkout-detail-row'>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Samhita '22 ticket</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Admit: 1</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Price: ₹ 300</th>
                                        </tr>
                                        ...
                                        <tr className = 'checkout-detail-row'>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Machine Learning and Deep Learning Workshop</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Admit: 1</th>
                                        ...
                                        <tr className = 'checkout-detail-row'>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Ethical Hacking and Cyber Security Workshop</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Admit: 1</th>
                                        ...
                                        <tr className = 'checkout-detail-row'>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Cloud Computing with AWS</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Admit: 1</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Price: ₹ 799</th>
                                        </tr>
                                        ...
                                        <tr className = 'checkout-detail-row'>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>UI/UX Bootcamp using React Natives</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Admit: 1</th>
                                            <th style = {{border: '1.5px solid #0071BC'}} className = 'has-text-centered'>Price: ₹ 799</th>
                                        </tr>
